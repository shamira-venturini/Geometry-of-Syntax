...
`scripts/28_export_demo_prompt_csvs.py`. The specialized complex-NP Experiment
4 materials are generated by `scripts/43_build_exp4_complex_np_role_recovery.py`
and `scripts/44_export_exp4_complex_np_prompts.py`.
