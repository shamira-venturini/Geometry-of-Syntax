...
DEFAULT_VOCAB_PATH = REPO_ROOT / "corpora" / "transitive" / "jabberwocky_transitive_strict_vocabulary.json"
DEFAULT_OUTPUT_VOCAB = REPO_ROOT / "corpora" / "transitive" / "jabberwocky_transitive_strict_bpe_filtered_vocabulary.json"
