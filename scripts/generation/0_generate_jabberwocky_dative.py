...
<<<<<<< HEAD:scripts/generation/0_generate_jabberwocky_dative.py
...
>>>>>>> parent of c39105d (fixed generation script with vocabulary control):scripts/0_generate_jabberwocky_dative.py
NUM_SAMPLES = 15000
random.seed(42)
